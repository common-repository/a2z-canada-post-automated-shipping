...
*Release Date - 24 Jun 2023*
	>Redused configurations on initial setup

= 2.3.9 =
*Release Date - 29 May 2023*
	>Added option to show rates with tax.

= 2.3.8 =
*Release Date - 5 May 2023*
	>Fixed invoice not viewing for multiple packages.
...
= 2.3.6 =
*Release Date - 18 April 2023*
	>Fix fatal error when passing empty value for weight and dimension conversion
...
= 2.3.3 =
*Release Date - 27 Februray 2023*
	>minor bugfix

= 2.3.2 =
*Release Date - 20 Februray 2023*
	>minor bugfix
...
= 2.3.0 =
*Release Date - 14 Februray 2023*
	> Added option to link with shipo using intergation key
...
*Release Date - 01 August 2022*
	>minor bug fix, intergration filed add
