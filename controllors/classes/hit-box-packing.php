 ...
 */
	 ...
	 */
		public function add_item( $length, $width, $height, $weight, $value = '', $meta = array() ) {
			$this->items[] = new hit_Boxpack_Item_Cpost( $length, $width, $height, $weight, $value, $meta );
		}
	 ...
	 */
		public function add_box( $length, $width, $height, $weight = 0, $packtype = '' ) {
			$new_box = new hit_Boxpack_Box_CPost( $length, $width, $height, $packtype, $weight );
			$this->boxes[] = $new_box;
			return $new_box;
		}
...
/**
 * hit_Boxpack_Box_CPost class.
 */
class hit_Boxpack_Box_CPost {
...
/**
 * hit_Boxpack_Item_Cpost class.
 */
class hit_Boxpack_Item_Cpost {
